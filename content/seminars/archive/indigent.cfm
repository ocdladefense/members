...
<CFset #SpecialDate# = #ParseDateTime("October 16, 2000")#>
...
<CFset #SeminarName# = "Indigent Defense Management Seminar">
...
<FONT SIZE=+1>October 26-28, 2000, Inn at Otter Crest</FONT><BR>
</CENTER>
</TD>
</TR>
<TR>
...
Registration fee includes: admission to both days of the seminar, written material, continental
breakfast and lunch on Friday, continental breakfast on Saturday, refreshments at the breaks,
and an OCDLA hosted Oregon Coast Aquarium dinner on Thursday evening (guest tickets are $20). Note:
The Thursday Commission Meeting is a public meeting.
<p>
...
<TD VALIGN=TOP>
$165 pre-registration (<b>$150</b> before #DateFormat(SpecialDate, "mmmm d")#)</TD></TR>
</TABLE>
...
<TD VALIGN=TOP>
$110 (<b>$95</b> before #DateFormat(SpecialDate, "mmmm d")#)</TR>
</TABLE>
...
<br>
<TABLE>
<TR><TD valign=top colspan=3><b>&nbsp;&nbsp;Guest Tickets for Thursday Evening Aquarium Dinner</b><br>
Advance payment required. (Includes buffet dinner and admission to the Oregon Coast Aquarium on
Thursday evening.) (Guest reservations must be made at least 48 hours in advance.)
...
<TR><TD valign=top valign=top>$10 x</TD><TD valign=top><input type="text" name="aquariumchildren" value="#aquariumchildren#" size=2></TD>
...
<TR>
<TD VALIGN=TOP COLSPAN=2>
<FONT SIZE=+1>Refund Policy</FONT>
</TD>
</TR>
<TR><TD>
Refund less $15 cancellation fee if cancellation made by October 25. No show will be sent
the written materials and audiotapes. Questions? Call OCDLA at (541)686-8716.
</TD></TR>
</TABLE>
...
<TR>
<TD VALIGN=TOP COLSPAN=2>
<FONT SIZE=+1>Hotel Reservations</FONT>
</TD>
</TR>
<TR><TD>
Call the Inn at Otter Crest, 1-800-452-2101. OCDLA rates start at $80/night. Rooms will be released
September 26.
</TD></TR>
</TABLE>
...
<CFif (#Val(aquariumadults)# neq 0) OR (#Val(aquariumchildren)# neq 0)>
  <CFset #subprice# = (#Val(aquariumadults)# * 20) + (#Val(aquariumchildren)# * 10)>
  ...
  <CFset #MessageText# = #MessageText# & #CRLF# & "Aquarium Dinner - #Val(aquariumadults)# adult(s) and #Val(aquariumchildren)# child(ren): $#subprice#">
</CFif>
