...
<CFset #SpecialDate# = #ParseDateTime("March 1, 2001")#>
...
<CFset #SeminarName# = "Search and Seizure Seminar">
...
<CFparam Name="manual" Default="none">
...
<FONT SIZE=+1>March 10, 2001</FONT><BR>
<FONT SIZE=+1>Valley River Inn, Eugene</FONT><BR>
</CENTER>
</TD>
</TR>
<TR>
...
<TD VALIGN=TOP>
$140 pre-registration (<b>$125</b> before #DateFormat(SpecialDate, "mmmm d")#) for lawyers.</TD></TR>
<TR>
<TD VALIGN=TOP>
<input type="radio" name="attend" value="ocdlamembernonlawyer" <CFif #attend# eq "ocdlamembernonlawyer">checked</CFif>>
</TD>
<TD VALIGN=TOP>
$95 pre-registration (<b>$80</b> before #DateFormat(SpecialDate, "mmmm d")#) for nonlawyers.</TD></TR>
</TABLE>
...
<TD VALIGN=TOP>
$190 (<b>$175</b> before #DateFormat(SpecialDate, "mmmm d")#) for lawyers.</TR>
<TR>
<TD VALIGN=TOP>
<input type="radio" name="attend" value="nonmembernonlawyer" <CFif #attend# eq "nonmembernonlawyer">checked</CFif>>
</TD>
<TD VALIGN=TOP>
$140 (<b>$125</b> before #DateFormat(SpecialDate, "mmmm d")#) for nonlawyers.</TR>
...
<TR><TD valign=top><input type="radio" name="attend" value="membercantattend" <CFif #attend# eq "membercantattend">checked</CFif>></TD>
    <TD valign=top>$65 (members) Send me the written materials.</TD></TR>
...
<TR><TD valign=top><input type="radio" name="attend" value="nonmembercantattend" <CFif #attend# eq "nonmembercantattend">checked</CFif>></TD>
    <TD valign=top>$90 (nonmembers) Send me the written materials.</TD></TR>
...
<TR><TD valign=top><input type="radio" name="attend" value="writtenandtapescantattend" <CFif #attend# eq "writtenandtapescantattend">checked</CFif>></TD>
    <TD valign=top>$125 (members only) Please send me the written material and audiotapes.</TD></TR>
...
<TR>
<TD VALIGN=TOP COLSPAN=2>
<FONT SIZE=+1>New 2001 Edition - Search and Seizure Manual</FONT><br>
Special Discount Price for Seminar Attendees
</TD>
</TR>
<TR><TD><input type="radio" name="manual" value="member" <CFif #manual# eq "member">checked</CFif>></TD>
    <TD>$100 for OCDLA Members</TD></TR>
<TR><TD><input type="radio" name="manual" value="nonmember" <CFif #manual# eq "nonmember">checked</CFif>></TD>
    <TD>$155 for nonmembers</TD></TR>

<TR><TD><input type="radio" name="manual" value="none" <CFif #manual# eq "none">checked</CFif>></TD>
    <TD>none</TD></TR>
...
<CFif #attend# eq "ocdlamemberlawyer">
  <CFif #Special# neq 1>
    ...
    <tr><td>Registration (member)</td><td align=right>$140</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Member Lawyer $140">
  <CFelse>
    <CFset #TotalAmount# = #TotalAmount# + 125>
    <tr><td>Registration (member)</td><td align=right>$125</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Member Lawyer $125">
  </CFif>
<CFelseif #attend# eq "ocdlamembernonlawyer">
  ...
  <CFelse>
    ...
    <tr><td>Registration (member)</td><td align=right>$80</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Member Nonlawyer $80">
  </CFif>
<CFelseif #attend# eq "nonmemberlawyer">
  ...
  <CFelse>
    ...
    <tr><td>Registration (nonmember)</td><td align=right>$175</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Nonmember Lawyer $175">
  </CFif>
<CFelseif #attend# eq "nonmembernonlawyer">
  <CFif #Special# neq 1>
    <CFset #TotalAmount# = #TotalAmount# + 140>
    <tr><td>Registration (nonmember)</td><td align=right>$140</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Nonmember Lawyer $140">
  <CFelse>
    <CFset #TotalAmount# = #TotalAmount# + 125>
    <tr><td>Registration (nonmember)</td><td align=right>$125</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Nonmember Lawyer $125">
  </CFif>
<CFelseif #attend# eq "membercantattend">
  <CFset #TotalAmount# = #TotalAmount# + 65>
  <tr><td>Written Materials (member)</td><td align=right>$65</td></tr>
  <CFset #MessageText# = #MessageText# & #CRLF# & "Member Cannot Attend: Send Written Materials $65">
<CFelseif #attend# eq "nonmembercantattend">
  <CFset #TotalAmount# = #TotalAmount# + 90>
  <tr><td>Written Materials (nonmember)</td><td align=right>$90</td></tr>
  <CFset #MessageText# = #MessageText# & #CRLF# & "Member Cannot Attend: Send Written Materials $90">
<CFelseif #attend# eq "writtenandtapescantattend">
  <CFset #TotalAmount# = #TotalAmount# + 125>
  <tr><td>Audio Tapes and Written Materials(member)</td><td align=right>$125</td></tr>
  <CFset #MessageText# = #MessageText# & #CRLF# & "Member Cannot Attend: Send Tapes and Written Materials $125">
</CFif>
...
<CFif #manual# eq "member">
  <CFset #TotalAmount# = #TotalAmount# + 100>
  <tr><td>Search and Seizure Manual (member)</td><td align=right>$100</td></tr>
  <CFset #MessageText# = #MessageText# & #CRLF# & "Search and Seizure Manual (member) $100">
<CFelseif #manual# eq "nonmember">
  <CFset #TotalAmount# = #TotalAmount# + 155>
  <tr><td>Search and Seizure Manual (nonmember)</td><td align=right>$155</td></tr>
  <CFset #MessageText# = #MessageText# & #CRLF# & "Search and Seizure Manual (nonmember) $155">
</CFif>
