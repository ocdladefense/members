...
<CFset #SpecialDate# = #ParseDateTime("April 16, 2002")#>
...
<CFset #SeminarName# = "Criminal Investigation: Inside the Laboratory">
...
<FONT SIZE=+1>Apr 26-27, 2002</FONT><BR>
<FONT SIZE=+1>Host Hotel: Best Western Agate Beach Inn, Newport</FONT><BR>
</CENTER>
</TD>
</TR>
<TR>
...
Includes admission to both days of the seminar, CLE written material, continental breakfast
and lunch on Saturday, and refreshments at the breaks.
<p>
...
<TD VALIGN=TOP>
$165 pre-registration (<b>$150</b> before #DateFormat(SpecialDate, "mmmm d")#) for members.</TD></TR>
</TABLE>
...
<TR>
<TD VALIGN=TOP COLSPAN=2>
<FONT SIZE=+1>Host Hotel: Best Western Agate Beach Inn, Newport</FONT>
</TD>
</TR>
Singles or doubles begin at $69 and ocean-view rooms are just $92. Call 1-800-547-3310
for reservations. Specify that you're with OCDLA. Rooms to be released after March 25, 2002.
</TD></TR>
</TABLE>
...
<CFelseif #attend# eq "nonmembercantattend">
  ...
  <CFset #MessageText# = #MessageText# & #CRLF# & "Nonmember Cannot Attend: Send Written Materials $100">
