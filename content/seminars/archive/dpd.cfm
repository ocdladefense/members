...
<CFset #SpecialDate# = #ParseDateTime("October 3, 2000")#>
...
<CFset #SeminarName# = "Death Penalty Defense Seminar">
...
<FONT SIZE=+1>October 13-14, 2000, Hallmark Resort, Newport</FONT><BR>
</CENTER>
</TD>
</TR>
<TR>
...
<p>
<b>Registration</b> includes admission to the seminar, written material, continental breakfast and
lunch on Saturday, and refreshments at the breaks. Payment must accompany registration.
</TD></TR></TABLE>
...
<TD VALIGN=TOP>
$200 (<b>$185</b> before #DateFormat(SpecialDate, "mmmm d")#) for lawyers.</TR>
<TR>
<TD VALIGN=TOP>
<input type="radio" name="attend" value="nonmembernonlawyer" <CFif #attend# eq "nonmembernonlawyer">checked</CFif>>
</TD>
<TD VALIGN=TOP>
$140 (<b>$135</b> before #DateFormat(SpecialDate, "mmmm d")#) for nonlawyers.</TR>
...
<TR><TD>
Registration less $15 cancellation fee for cancellations made by October 12. No-shows will be sent
the written material and audiotapes.
</TD></TR>
</TABLE>
...
<TR><TD>
Call the Hallmark Resort, 1-800-982-8668. OCDLA rates are $79-99. Rooms will be released September 13th.
</TD></TR>
</TABLE>
...
<CFelseif #attend# eq "nonmembernonlawyer">
  ...
  <CFelse>
    ...
    <tr><td>Registration (nonmember)</td><td align=right>$135</td></tr>
    <CFset #MessageText# = #MessageText# & #CRLF# & "Registration: Nonmember Lawyer $135">
  </CFif>
