...
<div class="project auto-page-break" data-id="<?php print $project; ?>" id="<?php print $project; ?>">
	<div class="project-info-wrapper">
		...
		<h3 id="toggle-duties-<?php print $project ?>" data-toggle="duties-<?php print $project ?>" class="project-heading project-heading-active">Responsibilities</h3>
		<div class="project-content">
			...
			<h3 id="toggle-projects-<?php print $project ?>" data-toggle="projects-<?php print $project ?>" class="project-heading">Major Projects</h3>
