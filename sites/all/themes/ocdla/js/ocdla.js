...
//function toConsole(data){
	...
	var logout_url = ocdlaSettings.logoutUrl;//"https://auth.ocdla.org/logout";
	...
	is_tester = is_tester[0].firstChild.nodeValue == 1 ? true : false;
	...
	/*
	  ...
	  *
	   */
		...
		// 		<a href="/cart/index_newocdla.cfm"><strong>OCDLA Store</strong></a>|
...
function init(){
	...
	if( login ) {
		ocdlaSettings.loginCallback(login);
	}
